...
import "./Bhojnalya.css";

const mediaFiles = [
  { type: "image", src: "/images/bhojnalya1.jpg" },
  { type: "image", src: "/images/bhojnalya2.jpg" },
  { type: "image", src: "/images/bhojnalya3.jpg" },
  { type: "image", src: "/images/bhojnalya4.jpg" },
  { type: "video", src: "/videos/bhojnalya1.mp4" }
];
...
const Bhojnalya = () => {
  ...
  return (
    <div className="bhojnalya-container">
      <h1>Bhojnalya</h1>

      <div className="bhojnalya-description">
        <p>
          Our Bhojnalya serves fresh, nutritious, and traditional meals with a focus on hygiene
          and quality. Experience a welcoming dining environment with a variety of delicious dishes.
        </p>
      </div>
      ...
      <div className="gallery">
        {mediaFiles.map((item, index) => (
          <div key={index} className="gallery-item" onClick={() => openMedia(index)}>
            {item.type === "image" ? (
              <img src={item.src} alt={`Bhojnalya ${index + 1}`} className="gallery-item" />
            ) : (
