...
const Gaushala = () => {
  ...
  return (
    <div className="gaushala-page">
      ...
      <section className="about-gaushala">
        <h2>गौशाला</h2>
        <p>
        हमारे यहां पर सो गायों की गौशाला जिसमें अपने देसी नस्ल की गए जिसमें साहिवाल हरियाणवी, राठी तथा थारपारकर नस्ल की गाय हैं इसका उद्देश्य यह है कि जैसा कि आज के प्रवेश में नकली दूध तथा प्लास्टिक थैली में आज दूध के नाम पर जहर दिया जा रहा है उसे कंट्रोल करना तथा हमारे युवाओं को यह समझाना की गाय के माध्यम से अच्छी कमाई कर सकते हैं तथा अपने परिवार और अपने पड़ोस के लोगों को भी हम अच्छा दूध दे सकते हैं।
        </p>
      </section>
